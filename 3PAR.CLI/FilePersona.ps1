...
[CmdletBinding()]
Param(
	[Parameter(Mandatory)]	[String]	$VFSName,
...
Process 
	...
	{	if($Result.StatusCode -eq 200)
			...
			{	Write-Error "Failure : While Executing Get-A9FileStoreSnapshot." 
				return $Result.StatusDescription
			}
	}	
}
...
Process 
	...
	{	if($Result.StatusCode -eq 200)
			...
			{	Write-Error "Failure : While Executing Get-A9FilePersonaQuota." 
				return $Result.StatusDescription
			}
	}	
}
