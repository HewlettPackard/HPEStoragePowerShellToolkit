...
#>
[CmdletBinding()]
Param(	[Parameter(ParameterSetName = "Enabled",  Mandatory, ValueFromPipeline=$true)]	[switch]	$Enable,
		[Parameter(ParameterSetName = "disabled", Mandatory, ValueFromPipeline=$true)]	[switch]	$Disable
)
Begin 
