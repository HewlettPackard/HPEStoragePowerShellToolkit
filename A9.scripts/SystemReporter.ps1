...
{	$Result = $null
	...
	if($Result.StatusCode -eq 200)
		{	if($dataPS.Count -gt 0)
				...
				{	Write-Error "Failure:  While Executing Get-A9CPGSpaceDataReports. Expected Result Not Found with Given Filter Option ." 
					return 
				}
		}
	else
		{	Write-Error "Failure:  While Executing Get-A9CPGSpaceDataReports." 
			return $Result.StatusDescription
		}
}	
}
...
{	$Result = $null
	...
	if($Result.StatusCode -eq 200)
		{	if($dataPS.Count -gt 0)
				...
				{	Write-Error "Failure:  While Executing Get-A9CPGStatisticalDataReports. Expected Result Not Found with Given Filter Option ." 
					return 
				}
		}
	else
		{	Write-Error "Failure:  While Executing Get-A9CPGStatisticalDataReports." 
			return $Result.StatusDescription
		}
}	
}
...
{	$Result = $null
	...
	if($Result.StatusCode -eq 200)
		{	if($dataPS.Count -gt 0)
				...
				{	Write-Error "Failure:  While Executing Get-A9CPUStatisticalDataReports. Expected Result Not Found with Given Filter Option ." 
					return 
				}
		}
	else
		{	Write-Error "Failure:  While Executing Get-A9CPUStatisticalDataReports." 
			return $Result.StatusDescription
		}
}	
}
	...
	if($Result.StatusCode -eq 200)
		{	$dataPS = ($Result.content | ConvertFrom-Json).members
			if($dataPS.Count -gt 0)
				...
				{	Write-Error "Failure:  While Executing Get-A9PDCapacityReports. Expected Result Not Found with Given Filter Option ." 
					return 
				}
		}
	else
		{	Write-Error "Failure:  While Executing Get-A9PDCapacityReports." 
			return $Result.StatusDescription
		}
}	
}
...
{	$Result = $null
	...
	if($Result.StatusCode -eq 200)
		{	if($dataPS.Count -gt 0)
			...
			{	Write-Error "Failure:  While Executing Get-A9PDStatisticsReports. Expected Result Not Found with Given Filter Option ." 
				return 
			}
		}
	else
		{	Write-Error "Failure:  While Executing Get-A9PDStatisticsReports." 
			return $Result.StatusDescription
		}
}	
}
...
{	$Result = $null
	...
	if($Result.StatusCode -eq 200)
		{	$dataPS = ($Result.content | ConvertFrom-Json).members
			...
			{	Write-Error "Failure:  While Executing Get-A9QoSStatisticalReports. Expected Result Not Found with Given Filter Option ." 
				return 
			}
		}
	else
		{	Write-Error "Failure:  While Executing Get-A9QoSStatisticalReports." 
			return $Result.StatusDescription
		}
}	
}
	...
	if($Result.StatusCode -eq 200)
		{	$dataPS = ($Result.content | ConvertFrom-Json).members
			if($dataPS.Count -gt 0)
				...
				{	Write-Error "Failure:  While Executing Get-A9RCopyStatisticalReports. Expected Result Not Found with Given Filter Option ." 
					return 
				}
		}
	else
		{	Write-Error "Failure:  While Executing Get-A9RCopyStatisticalReports." 
			return $Result.StatusDescription
		}
}	
}
	...
	if($Result.StatusCode -eq 200)
		{	$dataPS = ($Result.content | ConvertFrom-Json).members
			if($dataPS.Count -gt 0)
				...
				{	Write-Error "Failure:  While Executing Get-A9RCopyVolumeStatisticalReports. Expected Result Not Found with Given Filter Option ." 
					return 
				}
		}
	else
		{	Write-Error "Failure:  While Executing Get-A9RCopyVolumeStatisticalReports." 
			return $Result.StatusDescription
		}
}	
}
