...
OVERVIEW
	...
	New features in HPE Alletra 9000 and Primera and 3PAR PowerShell Toolkit 3.5
...
Features of HPE Alletra 9000 and Primera and 3PAR PowerShell Toolkit
-----------------------------------------------------------------------------------------------
HPE Alletra 9000 and Primera and 3PAR PowerShell Toolkit 3.5 works with PowerShell 5.0 or 
later up to PowerShell 7+. 
...
NOTE: PowerShell 5.x and PowerShell 7 are supported only for CLI and WSAPI connections. 
