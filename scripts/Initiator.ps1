# Initiator.ps1: This is an autogenerated file. Part of Nimble Group Management SDK. All edits to this file will be lost!
#
...
function New-NSInitiator {
  ...
  param(
    ...
    [Nullable[bool]] $override_existing_alias
...
function Get-NSInitiator {
  ...
  param(
    ...
    [ValidateSet('id','access_protocol','initiator_group_id','initiator_group_name','label','iqn','ip_address','alias','chapuser_id','wwpn','vp_override','creation_time','last_modified','override_existing_alias')]
    [string[]]$fields,
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDU4aMoktf7xqZ2
# X1vBvKAd7IiqmJdDhRsev4G2jakbyKCCEKwwggUqMIIEEqADAgECAhEAvNU51iSY
...
# BCCMhtFFeVFfTMy41He6o3jLHXlJAMLQz3HGX67UKvAslzANBgkqhkiG9w0BAQEF
# AASCAQC7CezItTbrjgSMWeF/pNKHU46k9zdVi1bwGRfr00nJfE8GR2KUyl904un/
# X7Sns4v7VfKzAkyAsR36QTO7aHqmMhJu3WQt78ir/2HVfYSenwxGnMH1xZw2T1fO
# I03w3/hdxmOA9kXD1XzHhfh9L1ogBYj37vp/eJy9h6TPgy+pHcQ9ZSlfAtVrvWIb
# 0kgAjpUwN7eCjPFdhBZXKvQZoLYe5NrRK6yDEf3+Kiqh02iJSj49Da3BJJ+F4Oci
# P3LMz9fY2C69DVQg5p7orX4bdZZwerXh8zGv8781BkZGXgd2t3bme2Vu7qOrzmf0
# RND7nNxFYZQ8ard+KUPcnsKdx1FpoYIOPTCCDjkGCisGAQQBgjcDAwExgg4pMIIO
...
# AAQgAwXVBXJ6qa3SEi/Fg0FPJr9upvQ44ldEhYk8qCVoP2QCFQC7b0iyIdGYVXeF
# NIHdktiKJOikRhgPMjAyMjAyMTEwMjA2NDVaMAMCAR6ggYakgYMwgYAxCzAJBgNV
...
# CSqGSIb3DQEJBTEPFw0yMjAyMTEwMjA2NDVaMC8GCSqGSIb3DQEJBDEiBCANPvD0
# eIRvmeKdeGuKgzjNo5cWb7Cc5dwfwzABIkvBZjA3BgsqhkiG9w0BCRACLzEoMCYw
# JDAiBCDEdM52AH0COU4NpeTefBTGgPniggE8/vZT7123H99h+DALBgkqhkiG9w0B
# AQEEggEAp3u1wf5Xl5RNTPRH2wRRuwNz3WpvCkyGFqvCzkV+yCIuGq6+Y0T+8Hy4
# bkV7qWQAIw6+eeSZYV9N5JgAePEr9G94ogqIK5+s8ZwO8Iy0+HSezaQLfk5qBomE
# 675yitoyelK8ylKcerxug8RINQzvrclhL9xLih88OulnW/F7voIPzWFOe1VMp1P5
# 8HqRiebqOCbBxqMmxKPYXRrcIeCQYwJLita/B1/gMl29XuPXDC7OK60+dChB5oyd
# op2ocGU/BWTPfVToQfvEt0JNhBuS7yD4uc97aIVN7E1ZpL4hcS94Rrn1fyntnujk
# n5PCBrN6KbPUD1kPFFO6Pg713Jo6Hw==
