# FibreChannelConfig.ps1: This is an autogenerated file. Part of Nimble Group Management SDK. All edits to this file will be lost!
#
...
function Get-NSFibreChannelConfig {
  ...
  param(
    ...
    [ValidateSet('id','array_list','group_leader_array')]
    [string[]]$fields,
...
function Update-NSFibreChannelConfig {
    # .ExternalHelp ../NimPSSDK.psm1-help.xml
    ...
    [Parameter(ValueFromPipelineByPropertyName=$True, ParameterSetName='allArgs', Mandatory = $True)]
    [AllowEmptyString()]
    [string]$wwnn_base_str,

    [Parameter(ValueFromPipelineByPropertyName=$True, ParameterSetName='allArgs', Mandatory = $True)]
    
    [Nullable[bool]]$precheck
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC7C7DtAfz3vXd0
# 2A3JjgpheTTrw18PGV6pX6hNGBeLO6CCEKwwggUqMIIEEqADAgECAhEAvNU51iSY
...
# BCDWM2j6TfoQcnm/MCSXxZwQFot+yD4ZaaeexGQHMRbNXTANBgkqhkiG9w0BAQEF
# AASCAQCPh7uCHnIJsQ0JrU2ViWp2MODMFmfR8xVh0xKZuCqKmbnJVa1JlAVEkzAk
# gS0MnS2cTg2cAFvMrbvus5srKdQnjd6stxCAOBmanwu8p6emjCZieuZ7oCxcMvyl
# JZyLpJYET7xqbTron4uJLARl80xTllXv2AYZTJEO2fdDQzYpT7+dZEuvugUKOA4R
# 60qvvLoFJi3PJQg2tsDy/FRZl6YDnnBQ1aw0IPhTncMRC7CSdS96Cw/18yxk2rjH
# 5ojW+vTEDPpsp9ZpWpeisgqpb0e0RnoEqLMkUTuRYcs5SXo7CddqsbbRFg8f3DYA
# E6LkHj+KibfU9F161RdXL0spHnYJoYINfjCCDXoGCisGAQQBgjcDAwExgg1qMIIN
# ZgYJKoZIhvcNAQcCoIINVzCCDVMCAQMxDzANBglghkgBZQMEAgEFADB4BgsqhkiG
# 9w0BCRABBKBpBGcwZQIBAQYJYIZIAYb9bAcBMDEwDQYJYIZIAWUDBAIBBQAEIKOD
# Tz+8KXjytKaT59rPZgYvuQLwXalztBkQEg4Hn1ZpAhEA5zAC1VX4iM4/hatdnXh3
# 4hgPMjAyMjAyMTEwMTU4MzJaoIIKNzCCBP4wggPmoAMCAQICEA1CSuC+Ooj/YEAh
...
# HAYJKoZIhvcNAQkFMQ8XDTIyMDIxMTAxNTgzMlowKwYLKoZIhvcNAQkQAgwxHDAa
# MBgwFgQU4deCqOGRvu9ryhaRtaq0lKYkm/MwLwYJKoZIhvcNAQkEMSIEINll7Wup
# nuYQS/gmbWoxgYcPJG1l5xaHmF6YkG2l2qhfMDcGCyqGSIb3DQEJEAIvMSgwJjAk
# MCIEILMQkAa8CtmDB5FXKeBEA0Fcg+MpK2FPJpZMjTVx7PWpMA0GCSqGSIb3DQEB
# AQUABIIBAGKlLkF53fNLTY8T3JeTd2UpjVIDbsVwRNcPGQR5K6SbKh05Q2Zgn9/I
# MF12NxeJ1f9HgLGS6SF62TIzEypolqdan+EBfC2R8za+j9OwbnCZ1lIEFJ8AZ2ro
# StoCyvhQqfEgbcFo1NOjRIoRuOYrS2FAeRGtGpWib/5ujM4fQtMb5vdKfOmcdOaJ
# hbIPHO1Nww6Ie7lccbU7SnQE93EG2ZrTMdzCeqCVLe63Eqft0oKkT6IKezUuPIbl
# s3tmUoh+eVrTcYWILrWISBrVO/sIpWlpIzjhs++QMcDfNLqGiDQequa2nH2b7ViN
# zf2vQFxaLQKukJRK/2crtYKdkegOO2U=
