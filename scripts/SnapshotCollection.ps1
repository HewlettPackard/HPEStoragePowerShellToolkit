# SnapshotCollection.ps1: This is an autogenerated file. Part of Nimble Group Management SDK. All edits to this file will be lost!
#
...
function New-NSSnapshotCollection {
  ...
  param(
    ...
    [Nullable[bool]] $is_external_trigger,
    ...
    [Nullable[bool]] $start_online,

    [Parameter(ParameterSetName='allButId')]
    
    [Nullable[bool]] $allow_writes,
...
function Get-NSSnapshotCollection {
  ...
  param(
    ...
    [ValidateSet('id','name','description','volcoll_name','volcoll_id','origin_name','is_replica','srep_owner_name','srep_owner_id','peer_snapcoll_id','num_snaps','is_complete','is_manual','is_external_trigger','is_unmanaged','is_manually_managed','repl_status','repl_start_time','repl_complete_time','repl_bytes_transferred','creation_time','last_modified','online_status','vol_snap_attr_list','snapshots_list','replicate','replicate_to','start_online','allow_writes','disable_appsync','snap_verify','skip_db_consistency_check','sched_id','sched_name','invoke_on_upstream_partner','agent_type','expiry_after','metadata','force')]
    [string[]]$fields,
    ...
    [Parameter(ParameterSetName='nonId')]
    [string]$srep_owner_name,

    [Parameter(ParameterSetName='nonId')]
    [string]$srep_owner_id,

    [Parameter(ParameterSetName='nonId')]
    [string]$peer_snapcoll_id,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$num_snaps,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[bool]]$is_complete,
    ...
    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$repl_start_time,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$repl_complete_time,
    ...
    [Parameter(ParameterSetName='nonId')]
    [ValidateSet( 'offline', 'online', 'partial')]
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCANWYpz0F90LZd9
# E3OTbAq2kg/uxpJrx7P6gWjS0nw/J6CCEKwwggUqMIIEEqADAgECAhEAvNU51iSY
...
# BCBlbEPxDpIdy0yBkp27HEQPe45RtSTDmwmeR2Xnbna7sTANBgkqhkiG9w0BAQEF
# AASCAQAb2KOBjaDKxD7IZ7oa0Zpj8hd+PMRP2cDxAhxE8vAAiuXfJTkQnGZSs4vB
# 1lvWGXBekR0ex6FPmLd0fUlN1uh888feSFNSWinJVweSoNWP/EKAfmjI+OIqOzaO
# J9wxXCq/vhSY1Z/ewbh+cUmCUWB2E3ShEAtkRSnyQGhDcG0REdLD8CxiYxXUnRKX
# s4hiqkLNFBpuN/d6U3tHb9CbbIG4MhJEMzCoa1XfaCVJx1SCnFuP/rrNzoyuMg8l
# X7Q/HB4DSdYszNGnxx1BdsmWSCLe9U/aIpjR+W3QdWP3NlCW/R+p1di8jh3QIVda
# dXr3qeGVs1ZqjY49SMhT8NliZbCNoYIOPTCCDjkGCisGAQQBgjcDAwExgg4pMIIO
...
# AAQgeLp6yqiCwu9ec+YrYzPFcKHgyzJIDJ2pK5N5gANhIZ0CFQDNYuCoaGRtc9Kx
# T39HU//3AUc84xgPMjAyMjAyMTEwMjI1NTRaMAMCAR6ggYakgYMwgYAxCzAJBgNV
...
# CSqGSIb3DQEJBTEPFw0yMjAyMTEwMjI1NTRaMC8GCSqGSIb3DQEJBDEiBCCLOLnJ
# HEEE0Mo4hfpjsBUDSmyA3eu0b8pKtMTMlXAedTA3BgsqhkiG9w0BCRACLzEoMCYw
# JDAiBCDEdM52AH0COU4NpeTefBTGgPniggE8/vZT7123H99h+DALBgkqhkiG9w0B
# AQEEggEAJNhrq20d8hBAglnkZv/k2QJDyl9KXiS+yIeYHnfJnYLR8PAtQKFBp39s
# WLo5xYqZksiX2Ak3kj/wsNZbt48WIWxQF7lWbpqGboPuyBpUkrp4WiGEuiIwsnGP
# 7Q8DVe0taOGGyJ8B0OZdFCWcJKPHPXRLGpR40eoaO/67Fo5Hy9CLR67sLVr3foYO
# HHYSHN6Rtvu1uZqiqEY+t5bTLqq1QNM+KD7AO6QvPEhpZ9Ix393vxIU5MgM+5K9S
# FXMHdV8WAagQkv8az9LEI4PBNKyHt/tQuFSt5CAI3CJzzgti//J0d/n0g8cqXMZE
# UUHn+llbNmjtI+841U+JTloWSqiewg==
