# SoftwareVersion.ps1: This is an autogenerated file. Part of Nimble Group Management SDK. All edits to this file will be lost!
#
...
function Get-NSSoftwareVersion {
  ...
  param(
    ...
    [ValidateSet('version','signature','name','status','total_bytes','downloaded_bytes','blacklist_reason','release_date','is_manually_downloaded','release_status','no_partial_response')]
    [string[]]$fields,
    ...
    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$total_bytes,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$downloaded_bytes,

    [Parameter(ParameterSetName='nonId')]
    [string]$blacklist_reason,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$release_date,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[bool]]$is_manually_downloaded,

    [Parameter(ParameterSetName='nonId')]
    [string]$release_status,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[bool]]$no_partial_response
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA3kmcFl8QuBhO+
# Of4xo69MLe85oQGiuVIW/PVBG1lDp6CCEKwwggUqMIIEEqADAgECAhEAvNU51iSY
...
# BCBgRxc3Y9rsK2AKPHymSAuGs6o8sMO48u8wVS5vRWkNjjANBgkqhkiG9w0BAQEF
# AASCAQCddfA2jg+/lDpBQS2AOnF3Z5G26QOUAeZCcsd1gVQgiW0+5v+zbxmYfZ14
# B2NTU7++VIPvzjA8VlSyGD4f4rsSzJRzXkk1h1a28hqh2kgBjT4jjmjR2px7JGDk
# IT/RkLMC19RlaMxqEcvbXmFHAuDJ7aDxECWgIdQuCYHNiPLuua5iu9v7jLT4RNHP
# KUudeNAzhNV7LT1RRLguAf2nh7uUFG35cJS5C/W/00fgqegOu2oD7Y8UztO41m1I
# Z1TjGvF/CaGoHQKk2WeE8+A2WB1xc97o7GGg1OjC8gahwG5FlI/EhfV56t5T/XA4
# 1nTA0mwUGd7IR000HJBEnYE3MxOYoYINfjCCDXoGCisGAQQBgjcDAwExgg1qMIIN
# ZgYJKoZIhvcNAQcCoIINVzCCDVMCAQMxDzANBglghkgBZQMEAgEFADB4BgsqhkiG
# 9w0BCRABBKBpBGcwZQIBAQYJYIZIAYb9bAcBMDEwDQYJYIZIAWUDBAIBBQAEIJRF
# rSAhNWaD8k8GrAeVdXSs8QMAAmUQcIvOXlZjV4WJAhEAkKqkRkXB+JZADW8PsKI0
# 0hgPMjAyMjAyMTEwMjI2MTZaoIIKNzCCBP4wggPmoAMCAQICEA1CSuC+Ooj/YEAh
...
# HAYJKoZIhvcNAQkFMQ8XDTIyMDIxMTAyMjYxNlowKwYLKoZIhvcNAQkQAgwxHDAa
# MBgwFgQU4deCqOGRvu9ryhaRtaq0lKYkm/MwLwYJKoZIhvcNAQkEMSIEILFKSHC/
# X4Yq/dkjMvc1yYvRHuRX+9qrF/KIVudU84nnMDcGCyqGSIb3DQEJEAIvMSgwJjAk
# MCIEILMQkAa8CtmDB5FXKeBEA0Fcg+MpK2FPJpZMjTVx7PWpMA0GCSqGSIb3DQEB
# AQUABIIBAHcjoNc3X7IY2+FwzQtEMRUNZTJUJ0XYJcpplJmt3b5r8ENFmnIF64XB
# jQApjEiW2EAyF7Zqs+hBGs0Rc0NulE8hKjTXFxpGUazsZhT+Rog2boX5/PzBmYFr
# bpYgweh04RkdxEp3X8cEV6H5bVJFZubIDZyDtxwbpSf5dSihfdQL73OPGWUcvTya
# mtKDQDCOKDt88OYCjcTpoMD7L/BbW6qdrqIAGvljWBL0I32p219doTbCK5O73OOw
# fl0fHUIXjrU4bzvhWPN2bCScbyV9QcFHuh6S+d9fIryCpzIvv2DraKt3prt8Q0vh
# KsMJhJn1IZINctrntukZiatatPVHzeE=
