# ProtectionSchedule.ps1: This is an autogenerated file. Part of Nimble Group Management SDK. All edits to this file will be lost!
#
...
function New-NSProtectionSchedule {
  ...
  param(
    ...
    [Parameter(ParameterSetName='allButId', Mandatory = $True)]
    [ValidateSet( 'protection_template', 'volume_collection')]
    ...
    [Nullable[long]] $at_time,

    [Parameter(ParameterSetName='allButId')]
    
    [Nullable[long]] $until_time,
    ...
    [Nullable[long]] $replicate_every,

    [Parameter(ParameterSetName='allButId')]
    
    [Nullable[long]] $num_retain_replica,

    [Parameter(ParameterSetName='allButId')]
    
    [Nullable[long]] $repl_alert_thres,

    [Parameter(ParameterSetName='allButId')]
    
    [Nullable[bool]] $snap_verify,

    [Parameter(ParameterSetName='allButId')]
    
    [Nullable[bool]] $skip_db_consistency_check,

    [Parameter(ParameterSetName='allButId')]
    
    [Nullable[bool]] $disable_appsync,
...
function Get-NSProtectionSchedule {
  ...
  param(
    ...
    [ValidateSet('id','name','description','volcoll_or_prottmpl_type','volcoll_or_prottmpl_id','period','period_unit','at_time','until_time','days','num_retain','downstream_partner','downstream_partner_name','downstream_partner_id','upstream_partner_name','upstream_partner_id','replicate_every','num_retain_replica','repl_alert_thres','snap_verify','skip_db_consistency_check','disable_appsync','schedule_type','active','creation_time','last_modified','last_mod_sched_time','last_replicated_snapcoll_name','last_replicated_snapcoll_id','last_replicated_at_time','last_snap_time','next_snap_time','next_repl_snap_time','snap_counter','sched_owner_id','sched_owner_name','last_config_change_time','currently_replicating_snapcoll_name','vol_status_list','sync_repl_vol_status_list','use_downstream_for_DR')]
    [string[]]$fields,
    ...
    [Parameter(ParameterSetName='nonId')]
    [string]$downstream_partner_name,

    [Parameter(ParameterSetName='nonId')]
    [string]$downstream_partner_id,

    [Parameter(ParameterSetName='nonId')]
    [string]$upstream_partner_name,
    ...
    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$last_mod_sched_time,

    [Parameter(ParameterSetName='nonId')]
    [string]$last_replicated_snapcoll_name,

    [Parameter(ParameterSetName='nonId')]
    [string]$last_replicated_snapcoll_id,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$last_replicated_at_time,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$last_snap_time,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$next_snap_time,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$next_repl_snap_time,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$snap_counter,

    [Parameter(ParameterSetName='nonId')]
    [string]$sched_owner_id,

    [Parameter(ParameterSetName='nonId')]
    [string]$sched_owner_name,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$last_config_change_time,

    [Parameter(ParameterSetName='nonId')]
    [string]$currently_replicating_snapcoll_name,

    [Parameter(ParameterSetName='nonId')]
    [Object[]]$vol_status_list,

    [Parameter(ParameterSetName='nonId')]
    [Object[]]$sync_repl_vol_status_list,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[bool]]$use_downstream_for_DR
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCmk5Bpg+A6j/IF
# pY1oDvwrwYfsKHvPku3qIgBsJUjh4KCCEKwwggUqMIIEEqADAgECAhEAvNU51iSY
...
# BCCVZJyTWVOPqLZR6LsLH3S77/tB+AMlZ/KUMclWzMEXqDANBgkqhkiG9w0BAQEF
# AASCAQB6n6Lv6PPzDW7FJI70z7MPeOsKztBWKVo0d23j4WRsVHgcy1davRghCeG1
# 0SKOrm1kP66/ChJKXRSbHtOLsiWTLY+fU6nL9u5ZY44EycIjinshob3Xag8lDu4q
# RuCiIqXqFi/5T1jLiI1a/3IeMqB6Fs7/Uh08pUJVq+YfN2KLt0/yGMBRyrtiNwAT
# tW59JoQK1vG92PW/gvef3TAQMdf30nCU5X9c/bgXp0Gt4+kiaV0NwkGpl3aO/E8m
# onTE+Nmket3JK2+R/thAT8jnxQGnf9HloU/qXO/kopX0rjNrIbuYXZSmn9sdgwTB
# hbpECNSFN+3TP880yQbMAQoBkyZAoYINfTCCDXkGCisGAQQBgjcDAwExgg1pMIIN
# ZQYJKoZIhvcNAQcCoIINVjCCDVICAQMxDzANBglghkgBZQMEAgEFADB3BgsqhkiG
# 9w0BCRABBKBoBGYwZAIBAQYJYIZIAYb9bAcBMDEwDQYJYIZIAWUDBAIBBQAEIKiY
# Uq3RiUlrBYLNZhbHpKId+sl2ar4obg9aH6GsiJn+AhA3A4FWRGToP2awxZkJCc1d
# GA8yMDIyMDIxMTAyMjE1N1qgggo3MIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHO
...
# BgkqhkiG9w0BCQUxDxcNMjIwMjExMDIyMTU3WjArBgsqhkiG9w0BCRACDDEcMBow
# GDAWBBTh14Ko4ZG+72vKFpG1qrSUpiSb8zAvBgkqhkiG9w0BCQQxIgQgevbhuBEE
# m6P4YTgtL4mOuusikFlvmYqOy6+9/2phUQgwNwYLKoZIhvcNAQkQAi8xKDAmMCQw
# IgQgsxCQBrwK2YMHkVcp4EQDQVyD4ykrYU8mlkyNNXHs9akwDQYJKoZIhvcNAQEB
# BQAEggEABCeVQ+oXDI7kAsaq6EkpNgON5xBmCIhAxH/UMsL8bBV1eUpTklotE4XM
# xpKlW8KWfh0uZcr532NydydujJbRHxboKFgNBMamSyItnepxonOThNgZQeSVnhZH
# wdxskcQYiX/GEUYh3vRE3JKBKvOzRTqkl+97n3eN0XZWlJq8LOCNtuYxR7hPrWyX
# ZXeD0uGT9k6bF81VGCNNUG6EJY2+KGIGPZm3HKoQx+RKgUQLQy7GUVHIcJ58HdC2
# 0EY2nwGXQ8+cwHgVwhlpelVQOn6GLPtgrOZcoKUrMnog7+mHlX6bzFYdqCWjG76j
# uvQR8I+zimEcOeE4axC8T3lN6l6BhA==
