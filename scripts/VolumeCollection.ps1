# VolumeCollection.ps1: This is an autogenerated file. Part of Nimble Group Management SDK. All edits to this file will be lost!
#
...
function New-NSVolumeCollection {
  ...
  param(
    ...
    [Parameter(ParameterSetName='allButId')]
    [ValidateSet( 'synchronous', 'periodic_snapshot')]
    [string] $replication_type,

    [Parameter(ParameterSetName='allButId')]
    [ValidateSet( 'vss', 'vmware', 'none', 'generic')]
    [string] $app_sync,
    ...
    [Nullable[bool]] $is_standalone_volcoll,
...
function Get-NSVolumeCollection {
  ...
  param(
    ...
    [Parameter(ParameterSetName='nonId')]
    [ValidateSet( 'soft_available', 'not_applicable')]
    [string]$synchronous_replication_type,

    [Parameter(ParameterSetName='nonId')]
    [ValidateSet( 'in_sync', 'not_applicable', 'out_of_sync', 'unknown')]
    ...
    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$last_modified_time,

    [Parameter(ParameterSetName='nonId')]
    [Object[]]$volume_list,

    [Parameter(ParameterSetName='nonId')]
    [Object[]]$downstream_volume_list,

    [Parameter(ParameterSetName='nonId')]
    [Object[]]$upstream_volume_list,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$volume_count,

    [Parameter(ParameterSetName='nonId')]
    [Object[]]$cache_pinned_volume_list,

    [Parameter(ParameterSetName='nonId')]
    [Object]$last_snapcoll,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$snapcoll_count,

    [Parameter(ParameterSetName='nonId')]
    [Object[]]$schedule_list,

    [Parameter(ParameterSetName='nonId')]
    [string]$replication_partner,

    [Parameter(ParameterSetName='nonId')]
    [Object]$last_replicated_snapcoll,

    [Parameter(ParameterSetName='nonId')]
    [Object[]]$last_replicated_snapcoll_list,
    ...
    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$lag_time,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[bool]]$is_standalone_volcoll,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$total_repl_bytes,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$repl_bytes_transferred,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[bool]]$is_handing_over,

    [Parameter(ParameterSetName='nonId')]
    [string]$handover_replication_partner,
...
function Start-NSVolumeCollectionHandover {
    ...
    [Nullable[bool]]$override_upstream_down
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBirdfA1KeokSz6
# GMZhuLV9zkwRBOExaFrbjLxct+darqCCEKwwggUqMIIEEqADAgECAhEAvNU51iSY
...
# BCD18KT2UB0FTMcYDpwAA/feOZ/r6iTxa4XhzdOqzEIBNjANBgkqhkiG9w0BAQEF
# AASCAQBDl63Uj6TCDW7fRmZ3zCndvAjTUWnjC/cBD/w9GV6NPcNARP/eYtuUh1aB
# tVqrCoiK/B3dGuEJUI2bwMfaIItwfAmINBiNK9ysa33mG7ndlsyIJgrkaXp4PTxA
# H0UWLzMpol3rM9wqdZMb3uCFJFNUvIOzimLdA2hJ42L+7YTRV4B0wTX92h49bCWD
# CalDCdsGhHpBkG8LpODp6i2cuRvsgrU4Hgzv2siPDuogTcsQUrUDkKUfR/czdcmM
# cX9dHwUut2LsnRN6w8zGRN/FBQze9/YlAKbGUt+7qCix6IZtULQz2TdmOkqNfKcD
# fyYWXWJQRwANmi68je9upVI1wCnioYINfTCCDXkGCisGAQQBgjcDAwExgg1pMIIN
# ZQYJKoZIhvcNAQcCoIINVjCCDVICAQMxDzANBglghkgBZQMEAgEFADB3BgsqhkiG
# 9w0BCRABBKBoBGYwZAIBAQYJYIZIAYb9bAcBMDEwDQYJYIZIAWUDBAIBBQAEIMX9
# PUtvTK+36M/2nLiAqV4xTPM1tsDN/X9VQmXlWiNKAhASapTqGhLj+xLv2Kb6fvj1
# GA8yMDIyMDIxMTAyNDE0MVqgggo3MIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHO
...
# BgkqhkiG9w0BCQUxDxcNMjIwMjExMDI0MTQxWjArBgsqhkiG9w0BCRACDDEcMBow
# GDAWBBTh14Ko4ZG+72vKFpG1qrSUpiSb8zAvBgkqhkiG9w0BCQQxIgQgpZarauHF
# H37FNDeWb7jN7i71AUhSO3EYGR/W36cAUXUwNwYLKoZIhvcNAQkQAi8xKDAmMCQw
# IgQgsxCQBrwK2YMHkVcp4EQDQVyD4ykrYU8mlkyNNXHs9akwDQYJKoZIhvcNAQEB
# BQAEggEABqTSlDNXyuJ7So7YcQhqnpbO9SrgQXqD7G4CJR23W5WOhtEfInB7HINi
# 8Tt45zFVHH2Kxmyd86tVWf4doZ2dayOliOnAhJJ9yWK/dV+iIS1iQKjuwBJ+h6D9
# PzRX6MRswhQ+c6Yed4nBeufgp8iC+0OAelhY3QdmaeXvumNNNDMA/4zqMXqVNreg
# MKZv68W8bwWyLpwUAjerlQuNbWa1T1m0Yd7SflSmj++H8dSTsasCq7+j/vAp9n8P
# YYlf3lutXl5kgmraPZcB105DvuOqV43JU3zvnwZ0m4HLRV0+YH2e3SDFnMaDZq3x
# WkroM6hPkw/ktaiG6AGGY9pBc1vgEQ==
