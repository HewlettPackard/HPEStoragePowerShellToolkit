# FibreChannelPort.ps1: This is an autogenerated file. Part of Nimble Group Management SDK. All edits to this file will be lost!
#
...
function Get-NSFibreChannelPort {
  ...
  param(
    ...
    [ValidateSet('id','array_name_or_serial','controller_name','fc_port_name','bus_location','port','slot','orientation','link_info','rx_power','tx_power')]
    [string[]]$fields,
    ...
    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$rx_power,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$tx_power
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC/0BdUEIB/k70Q
# qnmAjsij7j7J1iaKMRn0HfDvWkiFJ6CCEKwwggUqMIIEEqADAgECAhEAvNU51iSY
...
# BCBCtpspZBy1UVCpGVAdpGYm/VYvm6SRrl40T6iRnksu4TANBgkqhkiG9w0BAQEF
# AASCAQCJJP0JgrLIVJuoWvGL0LdFYvURI1IT4kpQQr3u0oqhKeDrU2S2E9C148ot
# rBzwW34bGlgqINszpEwqE6AZ7Dqw19oySxxbjGQsywG6zVuzThHG9X6QvzLbf7UL
# hNLvP+cYcwxx1w33usix6qd/x+dbkds/3J8+6B5s7Wt+2wwOZxd/6qsHcbVRtKPX
# RSmh9E4leJm4o3xfU+agFkLcfX/F5UKV9FXiBuQ8Q5HYQPrQeNwD36142x53zm0c
# rbAFISIrtSxxFsfcfq+Od39ILMX9QqX3IafzBZKw+z29FJGcS3/gfP9+zz+a8hjP
# I8fzsD1QHNeXxZkZ0AOWgluC7ptqoYIOPTCCDjkGCisGAQQBgjcDAwExgg4pMIIO
...
# AAQgEv7MwgbK/hFhBwQdCh7yAUQ0dR4NSJ0SSlrdFWU+AAsCFQDImOc8vrIkEmXS
# ioX+5/R0xG7WQRgPMjAyMjAyMTEwMjAyNDVaMAMCAR6ggYakgYMwgYAxCzAJBgNV
...
# CSqGSIb3DQEJBTEPFw0yMjAyMTEwMjAyNDVaMC8GCSqGSIb3DQEJBDEiBCC2+Xxf
# 5vIxNwS4WZEzTO6MZgKR+94t84Q95a63JUrOWTA3BgsqhkiG9w0BCRACLzEoMCYw
# JDAiBCDEdM52AH0COU4NpeTefBTGgPniggE8/vZT7123H99h+DALBgkqhkiG9w0B
# AQEEggEAd9CSQZ61Z/+vZEkW4nFPBC1FmH+noxO124YOLf/o9A9pcroK8yToxMbJ
# KlhzKuinJsSSsCl85zr/a+2BJaXplX1N7Qn8sBUIKOfWtwokjJV9ZndoVNFcW9A9
# Qxj0NrVYNsG1b5xTPYiV+5rMhagYCBwNeK5hP8e5o38P9c+cIj+eYsCYz9sKg9iy
# CfgQi30wZfGSiSW9Fu+QB3gdykJ3Uujq3bNBewEyWhKRgdDnNhmSEMZ0sfdRg0mx
# Q03y0tbUW6bXrFikLKkyrBBggsNHAJswcbmzGNOPxw0HhW538Q2lJuOpoBMZuSpj
# SyNwVWMSQw8V5ZJXCZjMCG8eYMeA+g==
