# FibreChannelSession.ps1: This is an autogenerated file. Part of Nimble Group Management SDK. All edits to this file will be lost!
#
...
function Get-NSFibreChannelSession {
  ...
  param(
    ...
    [ValidateSet('id','initiator_info','target_info')]
    [string[]]$fields,

    [Parameter(ParameterSetName='id')]
    [ValidatePattern('([0-9a-f]{2})(0{8})([0-9a-f]{16})([0-9a-f]{16})')]
    [string] $id,

    [Parameter(ParameterSetName='nonId')]
    [Object]$initiator_info,
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDYT2WyAIRSMv6y
# Tie8Qtst2+o4nG5UHCbJ4iNqBXibg6CCEKwwggUqMIIEEqADAgECAhEAvNU51iSY
...
# BCAVcdAAj2g5O76Zuv35GyMbp2/czkL/+r0U1CTYXLLowDANBgkqhkiG9w0BAQEF
# AASCAQBjdacHqss8wQ3SsrfNGZsW3Ld21EJsLbjMnbZTCo0ZgjLl8TJF625e2PyW
# bOFZKRgqtF3d7709pA6faUDgYHci0gVV6kR2jtzcvHGvST/SP/VWXx6StsDJp6Tt
# vjh/STjfLxS+/MgXk4JrwfpwP74VwYLXijMeUd6ALODQv3MFE/1OlT47AhIbqGYU
# RMvIEC0N1V2+Obawz4DZTMNgTMjD80sKvCtWGJaPvpNHbXEc6NCBc9AcdppB5NWg
# w8tm3tTAZ78KLzQKIsSjohxPi4xsuj7rMWJJkCAFRShaNzOVKYZf5/aOIHbu+GJy
# Qv4xQd8wKTRJRoOT2SQpxw6Vu/DJoYINfjCCDXoGCisGAQQBgjcDAwExgg1qMIIN
# ZgYJKoZIhvcNAQcCoIINVzCCDVMCAQMxDzANBglghkgBZQMEAgEFADB4BgsqhkiG
# 9w0BCRABBKBpBGcwZQIBAQYJYIZIAYb9bAcBMDEwDQYJYIZIAWUDBAIBBQAEIL9J
# 7+hOsU73sMFfOvEyicaCtIhjqGyroEP5NXL6F+g6AhEAnbOtOgWCb+2LOG7BtJY9
# ZhgPMjAyMjAyMTEwMjAzMDhaoIIKNzCCBP4wggPmoAMCAQICEA1CSuC+Ooj/YEAh
...
# HAYJKoZIhvcNAQkFMQ8XDTIyMDIxMTAyMDMwOFowKwYLKoZIhvcNAQkQAgwxHDAa
# MBgwFgQU4deCqOGRvu9ryhaRtaq0lKYkm/MwLwYJKoZIhvcNAQkEMSIEIIMVyQ1Y
# 13QaiZG2ffK+ZRETGZbiQxn8emTA1Lem9GxcMDcGCyqGSIb3DQEJEAIvMSgwJjAk
# MCIEILMQkAa8CtmDB5FXKeBEA0Fcg+MpK2FPJpZMjTVx7PWpMA0GCSqGSIb3DQEB
# AQUABIIBAFvvGVx31pDxehldPUYVlByNA5/XpvoYo3qESD7XB3RlbGOFRPfkWDH6
# er/WCrmaAqVTIgbI9K38YF06OrUMjkQGeNQYGx/OnydekgX7t/tCKyNKncfUZSc+
# KR+kvG1SzMt70bnFweikAIgVUYXefb630soVcMJX7KerIOraRAAqrIZSCQUul0Yl
# zs0Xc/iPqwjU+IXt0YSyejmqtT+qTjGDNYdBDmmnOVizGPjzj0ccftISPuy4IDvU
# kws7C0dpSzCEO3WNt/4gf4VbrvMI3pZDOy+gVINxXE/UXFHPB9qzRbWqg5TxNAkG
# 7e2nws9OrFbm8e8I+mqbrIPEzAHyzN8=
