# User.ps1: This is an autogenerated file. Part of Nimble Group Management SDK. All edits to this file will be lost!
#
...
function New-NSUser {
  ...
  param(
    ...
    [Nullable[long]] $inactivity_timeout,
...
function Get-NSUser {
  ...
  param(
    ...
    [ValidateSet('id','name','search_name','description','role_id','role','password','auth_password','inactivity_timeout','creation_time','last_modified','full_name','email_addr','tenant_id','tenant_key','disabled','auth_lock','last_login','last_logout','logged_in')]
    [string[]]$fields,
    ...
    [Parameter(ParameterSetName='nonId')]
    [Nullable[bool]]$auth_lock,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$last_login,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$last_logout,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[bool]]$logged_in
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDnGlDqiXKoxoW7
# o5bMwsLIVd6JAd81n5HK0yZgbV1B3aCCEKwwggUqMIIEEqADAgECAhEAvNU51iSY
...
# BCBePg/a9xihBNLw8WtElrhNH04TG6LwOMh4r76WaMR06DANBgkqhkiG9w0BAQEF
# AASCAQArk0B+1Ug8VZ4qq08WppLIGv5vD1dR/WgHkfdpaVJV4VYxSECDSqSaHEWV
# vNF3rPjFHmtOd6AXzth3/aecHh15NuwMGGti8xVk7g/dXjRxANmXifhZRuzW2WHo
# ARc9nr33Vy8VcSl7tZcgM2wALUranqgWGZSllhysmnAY1+z7KVjv5rolNnGhfHd8
# rpF+zl7Zpfx2xM37/rsYc48XIQRYXrkl8M0SsifnivooLyaS4ifYnneKgelD1T7V
# BeabnAnJ0iRQ/hNFuRq48zV4wXOWYTlP6+XIdogEpVzw9bLRkiYkRoLuoWgAew62
# u5eqB72/Dn5R6zW/zxJJoCKNoWcjoYINfjCCDXoGCisGAQQBgjcDAwExgg1qMIIN
# ZgYJKoZIhvcNAQcCoIINVzCCDVMCAQMxDzANBglghkgBZQMEAgEFADB4BgsqhkiG
# 9w0BCRABBKBpBGcwZQIBAQYJYIZIAYb9bAcBMDEwDQYJYIZIAWUDBAIBBQAEICHF
# j2i7KP5soEughOJqfChPARJp87HyFRtsOytThfkVAhEA62UBzlRGdjs1kBN/k+4D
# dBgPMjAyMjAyMTEwMjMxNTVaoIIKNzCCBP4wggPmoAMCAQICEA1CSuC+Ooj/YEAh
...
# HAYJKoZIhvcNAQkFMQ8XDTIyMDIxMTAyMzE1NVowKwYLKoZIhvcNAQkQAgwxHDAa
# MBgwFgQU4deCqOGRvu9ryhaRtaq0lKYkm/MwLwYJKoZIhvcNAQkEMSIEID+fFeV1
# DAHLJ8cTMtHuR9qjpK2iFyaDBA7ONPoOwMHgMDcGCyqGSIb3DQEJEAIvMSgwJjAk
# MCIEILMQkAa8CtmDB5FXKeBEA0Fcg+MpK2FPJpZMjTVx7PWpMA0GCSqGSIb3DQEB
# AQUABIIBACVByQfaG990QoZBMSVZpAJsl6AC3LgXob36/Hx+Smd3hsosy9QBLd3G
# g3dDbs7wPevlISnVhnF2DhKcndtStLWrEDslG+bFBa8FmuvjI1djNASanbdRzUSX
# d/nL9ZtI2SLj36q3pT58Dldpy3xFRgb1fq+IfiBKNPqcbuliRhbgqZNxVrKNl4dQ
# NUzw6liZU/lnnCSvE+ok7ZPIhLjMvmoh1CKV1mYrDSrxepQCZuzwdWG0VeMS9i3B
# 8YoYRnzeF2b6dYR47rCxqIEVjAopPJBGLc2YLeDF5rvMjFjczHY2g7XnuHqWTJu6
# 2TzugXZH9lKvLLcZFce8vzcHWvYEEuA=
