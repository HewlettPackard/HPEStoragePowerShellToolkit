# FibreChannelInitiatorAlias.ps1: This is an autogenerated file. Part of Nimble Group Management SDK. All edits to this file will be lost!
#
...
function Get-NSFibreChannelInitiatorAlias {
  ...
  param(
    ...
    [ValidateSet('id','alias','wwpn','source')]
    [string[]]$fields,
    ...
    [Parameter(ParameterSetName='nonId')]
    [ValidateSet( 'fabric', 'invalid', 'user')]
    [string]$source
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDg6pgEVHCJ/RqB
# M8CAgW7jcl32iFdGys2BcPcZCllgn6CCEKwwggUqMIIEEqADAgECAhEAvNU51iSY
...
# BCBdVguviJMEXhEOE8KhJ9IYTVjwLkbxS1+S7vdwOK0uKzANBgkqhkiG9w0BAQEF
# AASCAQB33PV++YnW8lyWq3oPEeRxSD2r5xLVJdwBY9AKCBq3sUtMv25So5ShQA0E
# h7fSY/5CggmXOHaD2PeR0TUnKuOj6EZbzjVoTWtRjAJiM/0sOGDVHBw1zD9OVG2h
# ecuyrX1oTohBo7PX1UfCuQn7vQm9wZL20yB06Wobg2UrFypFH0H8mZics6H0IKYF
# t9tyrlwRJPMUlRGBxbvLrgIvSQpE2GU6Y7Mu4HpLeAJI91exTDCDW6iwCPhZqmo6
# fy1VRRFKnXNtjFNXJqREcEyy5T+XH5YhX78WS0Nkh2OX6VTWB2h2TwIdZx/xcc4B
# 4Io7EyUmTZHJ/Z42Zbmyf4esroT6oYIOPTCCDjkGCisGAQQBgjcDAwExgg4pMIIO
...
# AAQgGQjf/M5E99avd6TED0/Gnv+IW8Dc2+tl4gjFYx5WlV4CFQD8defEp0rMXZuB
# vXPa5UDn1aJrqRgPMjAyMjAyMTEwMTU4NTZaMAMCAR6ggYakgYMwgYAxCzAJBgNV
...
# CSqGSIb3DQEJBTEPFw0yMjAyMTEwMTU4NTZaMC8GCSqGSIb3DQEJBDEiBCCMDS8X
# +vbDsXih+8no8BAMtvmdOizUeyJ0pW1vB3VM+zA3BgsqhkiG9w0BCRACLzEoMCYw
# JDAiBCDEdM52AH0COU4NpeTefBTGgPniggE8/vZT7123H99h+DALBgkqhkiG9w0B
# AQEEggEApH9VeTZ1spLhlp533u5akc1h+jEkwnASDEwFBwa9XFuLYMet/nljVXGo
# 4LroF6+hNE+UqSlAVMno4GCqeT6Prwa3xpDiN7+vcrTwSum0HvFisPxTUpcQyhi8
# neWVuZFMiUZh5tBGr6x3vyYlUlHd2opGuNs3rxLNOtljKibTRNXhCtrQ5VSKWdl4
# +hm6drpPoZ42IYW3fajIst2A82Gd+glgbEe/ztvsMmmrq0/POkPdPNRoadCU6qYk
# kt7Fa66Jq3/aBt+HRnJyNV0VowcRwBBCgCJwd3hSe6olCMfCJKQP7md/ma8Bh51I
# AUh2EDu1rauwZBqky9/TFN/B4QCPTQ==
