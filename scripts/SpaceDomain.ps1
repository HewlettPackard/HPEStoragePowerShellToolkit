# SpaceDomain.ps1: This is an autogenerated file. Part of Nimble Group Management SDK. All edits to this file will be lost!
#
...
function Get-NSSpaceDomain {
  ...
  param(
    ...
    [ValidateSet('id','pool_id','pool_name','app_category_id','app_category_name','perf_policy_names','sample_rate','volume_count','deduped_volume_count','volumes','block_size','deduped','encrypted','usage','vol_logical_usage','snap_logical_usage','vol_mapped_usage','logical_dedupe_usage','physical_dedupe_usage','savings_compression','savings_dedupe','savings_clone','compressed_usage_bytes','uncompressed_usage_bytes','compression_ratio','dedupe_ratio','clone_ratio')]
    [string[]]$fields,
    ...
    [Parameter(ParameterSetName='nonId')]
    [string]$app_category_id,

    [Parameter(ParameterSetName='nonId')]
    [string]$app_category_name,

    [Parameter(ParameterSetName='nonId')]
    [Object[]]$perf_policy_names,
    ...
    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$deduped_volume_count,
    ...
    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$vol_logical_usage,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$snap_logical_usage,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$vol_mapped_usage,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$logical_dedupe_usage,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$physical_dedupe_usage,
    ...
    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$compressed_usage_bytes,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$uncompressed_usage_bytes,
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCHLE5qKvcXMms6
# T0W6VzsVLj38ikqqNDdukqaJ3Wj1maCCEKwwggUqMIIEEqADAgECAhEAvNU51iSY
...
# BCCdGxuLwavGV2UtZW0mVsbn9f23lqYr/gZyG4EDI1VMRDANBgkqhkiG9w0BAQEF
# AASCAQBycwvK93LaPvz5nQoqNH9C2uZCiQ/xqss77NLEUOmgLpiqLC+7QdC1b9N0
# FSF4LgySyjx434/ZKzMxsSVYU8tKJzWBi7ykEICZpPOiDz9DmYenVF+gHByZG17u
# CSaM5HsNhegkp8w8xhSDoDhtxPIvlo4fB+frZcm4SWeRU9CqC0HCpufopd6NVi1M
# iveIoIsaLn9OI/Uu47osN6Adw/x93/ZWZdJx26H0R+5PIzoU0mwOBLiRcuOrZcUb
# WaIsxYBh5stMfvr7cX2ECp9WSczlXwu6XGGrgYTr89NYUap2JpRmuOhfvEevWUMD
# VzPKZ4c6MHaeDyUeSmYXHP3yytploYIOPTCCDjkGCisGAQQBgjcDAwExgg4pMIIO
...
# AAQgyqj9s/2YNo8GbnwgHxst+PjY7F4MtSgFbJXlEPnGaa4CFQC4Dz+9XoMZIgZJ
# v1ZMl4kHrdsAKRgPMjAyMjAyMTEwMjI2NDBaMAMCAR6ggYakgYMwgYAxCzAJBgNV
...
# CSqGSIb3DQEJBTEPFw0yMjAyMTEwMjI2NDBaMC8GCSqGSIb3DQEJBDEiBCDYm/L5
# MOhkVxaYPRkFAEThsrR2/pmQmyZliWrWERklnDA3BgsqhkiG9w0BCRACLzEoMCYw
# JDAiBCDEdM52AH0COU4NpeTefBTGgPniggE8/vZT7123H99h+DALBgkqhkiG9w0B
# AQEEggEAKp+5QPgFEPdrM2GYisYN+ARkiRhOdaCyHQH2zSABRtVSCiNoxAS5Gw3e
# WtHsGg4pFqEuvxvZuX4qNc27Mljftok1FGIH5Gvf0PbEgplkOpH8ThYma3mjDV6Y
# 8XuT46tu9LX7hJoB1Zkf+U5RK3Pb1LcVI6WDJa0CzvgguTZUbrYz+w0Pq2oUWB3y
# 7N6KhHUwtgXcMCsnGSPuV1bh+CzuKzt1gm4/+ZNICqBg3fHNMe8lwV9G++bhLXD7
# Bg4zfb2WZclcDI3fEQ59gfcPrA6Zhekpoe4n7RNjLYIsWXrseVW6qIN2BD84+PoQ
# Vw7iS5c5GeZktuDlgYeD5qq6NfXLLw==
