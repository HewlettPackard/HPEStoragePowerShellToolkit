# LdapDomain.ps1: This is an autogenerated file. Part of Nimble Group Management SDK. All edits to this file will be lost!
#
...
function Get-NSLdapDomain {
  ...
  param(
    ...
    [ValidateSet('id','domain_name','domain_description','domain_enabled','server_uri_list','bind_user','bind_password','base_dn','user_search_filter','user_search_base_list','group_search_filter','group_search_base_list','schema_type')]
    [string[]]$fields,
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCI0+CL9DaO54a9
# lGHAkVWYzyH0lhZlKqxKFrBZYl8diKCCEKwwggUqMIIEEqADAgECAhEAvNU51iSY
...
# BCAe6v8xj/yqe79UEQF5IihCXsi1RP3jKh3Xwnkt+o6GkTANBgkqhkiG9w0BAQEF
# AASCAQBWAOOYSJSUxrcY0wXItnX3Mdl9qlbix0qsxhMwOGBlcHJsVd1AcXVX0QPc
# COAExqQVACZBhSZodU4Lu0gnwp3gmAsrxOji2SPV1nzbkt/piC4l82JvcO4yZyXm
# 6Qe4yWiB5urfbaisSQatNiPdAQYXP4pD0f8l4LPCxFn/rkF+RS0Exmi/rmqYw/xS
# qqScwFO2Zjwu7iQuknB/TO2l7HD3/xGzv/d4i/Yxoo5Imf1nTbQDi9inrOV3MnJa
# ASgWqpr7w24cr+HDU0rcXZw5gQGysdV4y2kg2UzRE7yquZPvMDLaksOS9ZGOP5UO
# z5sHkn3VQXH6DTHmhp8SydnnLYc5oYINfTCCDXkGCisGAQQBgjcDAwExgg1pMIIN
# ZQYJKoZIhvcNAQcCoIINVjCCDVICAQMxDzANBglghkgBZQMEAgEFADB3BgsqhkiG
# 9w0BCRABBKBoBGYwZAIBAQYJYIZIAYb9bAcBMDEwDQYJYIZIAWUDBAIBBQAEIKYO
# YoIBuGrl1DV7fbIQa1x+wGYBYay3lDTvgaxrqqLRAhBv9aOXrFpzoSfqTGxzZ3A8
# GA8yMDIyMDIxMTAyMTEzMlqgggo3MIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHO
...
# BgkqhkiG9w0BCQUxDxcNMjIwMjExMDIxMTMyWjArBgsqhkiG9w0BCRACDDEcMBow
# GDAWBBTh14Ko4ZG+72vKFpG1qrSUpiSb8zAvBgkqhkiG9w0BCQQxIgQgOyaEmee8
# CQ3AtNZJ4DOJYJbQh6v5JhsLXmkIMQzzHy4wNwYLKoZIhvcNAQkQAi8xKDAmMCQw
# IgQgsxCQBrwK2YMHkVcp4EQDQVyD4ykrYU8mlkyNNXHs9akwDQYJKoZIhvcNAQEB
# BQAEggEAXGI6VDIRY5mRtANIy494RlQHJiJ5RjjFYb3MPmyPQEjFboozPVFV/Lfi
# tmslJ+5mHG2/qmYHw1L+g3QJe0oEJruJ1k+sLA+pGpyLlSNi0DszeyyNamGXwEaf
# oex5TBL4tP91df+1GuVSu5IUkNMgW89Msoy+PRO5I/OL64vJexy7Dk35klqc6BIH
# ubcG7+t9NrxgpqVEegFxEO0gJBcD1ut/8yoIgi8CX840RkcGDhjKK40ei/xRLkXi
# fK8gGuTEM0ZTrqJ4uhEkSdaJpNFt78ZjglDPw2mjmdVoLsabCaAYIz5cEqIOqdnN
# VNQL8SOtadGAINTicwl3W/3QL3TUPg==
