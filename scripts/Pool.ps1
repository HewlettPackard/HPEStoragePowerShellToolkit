# Pool.ps1: This is an autogenerated file. Part of Nimble Group Management SDK. All edits to this file will be lost!
#
...
function New-NSPool {
  ...
  param(
    ...
    [Nullable[bool]] $dedupe_all_volumes
...
function Get-NSPool {
  ...
  param(
    ...
    [ValidateSet('id','name','full_name','search_name','description','creation_time','last_modified','capacity','usage','savings','savings_data_reduction','savings_compression','savings_dedupe','savings_clone','savings_vol_thin_provisioning','reserve','unused_reserve','free_space','cache_capacity','pinnable_cache_capacity','pinned_cache_capacity','dedupe_capacity_bytes','dedupe_usage_bytes','savings_ratio','data_reduction_ratio','compression_ratio','dedupe_ratio','clone_ratio','vol_thin_provisioning_ratio','snapcoll_count','snap_count','array_count','vol_count','array_list','unassigned_array_list','vol_list','pinned_vol_list','folder_list','force','usage_valid','uncompressed_vol_usage_bytes','uncompressed_snap_usage_bytes','all_flash','dedupe_capable','dedupe_all_volumes_capable','dedupe_all_volumes','is_default')]
    [string[]]$fields,
    ...
    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$unused_reserve,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$free_space,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$cache_capacity,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$pinnable_cache_capacity,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$pinned_cache_capacity,
    ...
    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$snapcoll_count,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$snap_count,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$array_count,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$vol_count,

    [Parameter(ParameterSetName='nonId')]
    [Object[]]$array_list,

    [Parameter(ParameterSetName='nonId')]
    [Object[]]$unassigned_array_list,

    [Parameter(ParameterSetName='nonId')]
    [Object[]]$vol_list,

    [Parameter(ParameterSetName='nonId')]
    [Object[]]$pinned_vol_list,
    ...
    [Parameter(ParameterSetName='nonId')]
    [Nullable[bool]]$dedupe_capable,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[bool]]$dedupe_all_volumes_capable,
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDp/xcJMRVgGh1X
# XoXk1XjtYTMM9Yt1mUPVCqTRcN5OYKCCEKwwggUqMIIEEqADAgECAhEAvNU51iSY
...
# BCDK1SDcHJqmlo5/lRiwCAB/3/GZJ6DzPBvKgAo0SZq9AzANBgkqhkiG9w0BAQEF
# AASCAQBwBuxpAzSdFiVa2IOjH28QBke4+H3vBMCDlHlG9RcblwWwPENhCTDTg77f
# HEpHbuezWyAqM+3wCTQhbhAfci7X3WivfHXd3t2gnFpy1kdbQJi1CQqLp8y0HZkZ
# oRp+MuGaG8+mUZDKCTi8ohO8KLzoMJIMevIq3jhoHK+Xjo5UgEna30K3W6d/lweX
# C6w1HPLfbwJhHcHeAjCIq7VaWA6e7/7LE8xVdzOWWAe0b3V+0V0TK8CtnPXqLFNF
# PojBpoV1MlVbj7PP3ES9sxVDQNNOm+JhWM+vN1dZPUqn5lY5n/dQzRsWpJ3QimdN
# +hj+XOgATCR039Jyjn3akWZ3GWLzoYINfTCCDXkGCisGAQQBgjcDAwExgg1pMIIN
# ZQYJKoZIhvcNAQcCoIINVjCCDVICAQMxDzANBglghkgBZQMEAgEFADB3BgsqhkiG
# 9w0BCRABBKBoBGYwZAIBAQYJYIZIAYb9bAcBMDEwDQYJYIZIAWUDBAIBBQAEIE3D
# TeGfsE5fAU7X5gAtdGbFpJFK5CZ4ZaktjSEkrCviAhAmWAPcHITOnNvUTgwLoOf4
# GA8yMDIyMDIxMTAyMjAwMVqgggo3MIIE/jCCA+agAwIBAgIQDUJK4L46iP9gQCHO
...
# BgkqhkiG9w0BCQUxDxcNMjIwMjExMDIyMDAxWjArBgsqhkiG9w0BCRACDDEcMBow
# GDAWBBTh14Ko4ZG+72vKFpG1qrSUpiSb8zAvBgkqhkiG9w0BCQQxIgQgnToE5WOp
# RowIFpE1TimCTuyVrXWJ7yKMKRHAfe9cB9gwNwYLKoZIhvcNAQkQAi8xKDAmMCQw
# IgQgsxCQBrwK2YMHkVcp4EQDQVyD4ykrYU8mlkyNNXHs9akwDQYJKoZIhvcNAQEB
# BQAEggEAorMn+KThzSbT4X8B4zZsnZkSe6rdf9QM+XauH45SQUCzSIWJYm47Tk8a
# 91K/hBAp1u5EvQ9rcrd8SJcGoWlc6B6bSmSrtlbg5BWevFG3QXLmNSa6+PA8Zqc8
# zvdN8zSrOIalNUhfN+J4EP5yZaf9mX+/Z8ajZHNcjgWihPRE+wYdQZ41qfI+Fwys
# npxaizNRx/YxEnlTogMDLLl19QXC8w3Z/TIQAHSgSkUT2naSsEGK7ZIBgTVP8HRM
# T0Zjm1Zsae8UdGRI07rWtDBDTNfN+oyRyQFmtj3VMCNpgOL5+HqW0wRx2EcHwLCZ
# LHRiTvCvsQN5YxSTw0P8DNS1ZTxt+Q==
