# AccessControlRecord.ps1: This is an autogenerated file. Part of Nimble Group Management SDK. All edits to this file will be lost!
#
...
function Get-NSAccessControlRecord {
  ...
  param(
    ...
    [ValidateSet('id','apply_to','chap_user_id','chap_user_name','initiator_group_id','initiator_group_name','lun','vol_id','vol_name','vol_agent_type','pe_id','pe_name','pe_lun','snap_id','snap_name','pe_ids','snapluns','creation_time','last_modified','access_protocol')]
    [string[]]$fields,
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA+kKN/vdwos3hE
# H3HE4heazbSIpL4gdIsHkfNcwqvzXKCCEKwwggUqMIIEEqADAgECAhEAvNU51iSY
...
# BCD+z8fmMqBLLIH0Axr2Sju6p/kZCpxukqbTJCOAQglM6zANBgkqhkiG9w0BAQEF
# AASCAQBzxtyuczI5t6kfR98uKMCDVLjGW3z6e1MZPjnN0liF0N0Rv+lbvmkHgpbV
# cre0p0mGeqDrFkLfaWJsQedpDRa2jG+KN79N8+fIskpKj0gK7R/Pk4TQ2im9IZlZ
# DgXgaAvSPZDJJcwsPXgsMNwswXKP9tFmE2rzF0b/KS5TjbKCGy6qYQgNduh8cy8i
# WnYh7LRSMoyw/pkdP6CFjvZF+SCH4phUur9nIkp4CueM2jLjed2tOMqaEPJa7Y4W
# kQHIbXhvADXu7lbeUJJZODdaUfsO7gUhF/3h3820WXI4EldKSKuqt+k/aqVugWXA
# iNQYjDR94mr3KNK6jmbi74KsF8i6oYINfjCCDXoGCisGAQQBgjcDAwExgg1qMIIN
# ZgYJKoZIhvcNAQcCoIINVzCCDVMCAQMxDzANBglghkgBZQMEAgEFADB4BgsqhkiG
# 9w0BCRABBKBpBGcwZQIBAQYJYIZIAYb9bAcBMDEwDQYJYIZIAWUDBAIBBQAEIEit
# IEEA8Lks3ScFTkdqHOBnhnn1gWngIPfLuh/7tQ4CAhEAnsl28zHcEi2MqLpn+KhF
# zhgPMjAyMjAyMTEwMTQxNTFaoIIKNzCCBP4wggPmoAMCAQICEA1CSuC+Ooj/YEAh
...
# HAYJKoZIhvcNAQkFMQ8XDTIyMDIxMTAxNDE1MVowKwYLKoZIhvcNAQkQAgwxHDAa
# MBgwFgQU4deCqOGRvu9ryhaRtaq0lKYkm/MwLwYJKoZIhvcNAQkEMSIEIBkeOJPD
# esKJ/S9UpelrVyzaNZvzcf5guotCLBCdd+gjMDcGCyqGSIb3DQEJEAIvMSgwJjAk
# MCIEILMQkAa8CtmDB5FXKeBEA0Fcg+MpK2FPJpZMjTVx7PWpMA0GCSqGSIb3DQEB
# AQUABIIBAKfBXmicK2QD+UVZDL/0Z1+wNTBTzwbpdi+GnFuAJzc6FV1KE+AmbmG6
# xckvWzUbxgKMsx0iJuSXeJ6Xqqui4qpWsfKuuhCPzkG8LXyRVQryG99TE5t7BooG
# FF/jMztZvSSCwPxw3dRVIURLfnsM4gie/EGuI+K7IO6YsjZLmqxY+Ek8wdwSuWCF
# 6ToBP8kZH5C7A79u/wgTmaHdj9MgTNIC/1lEqXxZFrHIwHlCCjK8Vn+mtO+y38r5
# 8/g6WGvDt/9kLiSIFA+tqh9wBHm138z1gCjDh2GCcl8T5gCK+XdWOF6xVCx9E4Oj
# YDLjqfmkmkG3U+/Al6ICaMiXlPxQyZk=
