# UserPolicy.ps1: This is an autogenerated file. Part of Nimble Group Management SDK. All edits to this file will be lost!
#
...
function Get-NSUserPolicy {
  ...
  param(
    ...
    [ValidateSet('id','allowed_attempts','min_length','upper','lower','digit','special','previous_diff','no_reuse','max_sessions')]
    [string[]]$fields,
    ...
    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$allowed_attempts,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$min_length,
    ...
    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$special,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$previous_diff,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$no_reuse,

    [Parameter(ParameterSetName='nonId')]
    [Nullable[long]]$max_sessions
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDUq8ln2bqova7Y
# Zmi7ExVoVvMT6Nht+G4VnRqaQ3vkPaCCEKwwggUqMIIEEqADAgECAhEAvNU51iSY
...
# BCBSt4ZMQqxdKsSnl20B3tlYYagImTHVYFXeevyqzuzz0TANBgkqhkiG9w0BAQEF
# AASCAQAkAO8FW/PkbL+T1zITmBiejPUzN0CCuCnI0+hTvfSra6onMK74OkIfXKMn
# gd3e/e1blFf8TaFAVx1LHgMnXnp6FtL1iv0gD1mvHs/SzLhIPpKJE9ANVmiI6bTs
# YMOHe3gWxbf71AELs0hD9d78C7L6CA2VM0xh0q0rw4iSneMvKYBd/LmuaQflD2cn
# vHmmZYGIf4ziqyXmW9OdeBWw8wFT4gZYTA2TKY1KEgCdJoPlZimSr/8+0vJepEKI
# g7woZdaFITxdjsfgiGRUCRhgpaxXaOLxX5RTUR6phEa3zDo2yrIRtXoe3EIirFLl
# CXmNnL0wxpPd9LScaxXlZyF6WX5UoYINfjCCDXoGCisGAQQBgjcDAwExgg1qMIIN
# ZgYJKoZIhvcNAQcCoIINVzCCDVMCAQMxDzANBglghkgBZQMEAgEFADB4BgsqhkiG
# 9w0BCRABBKBpBGcwZQIBAQYJYIZIAYb9bAcBMDEwDQYJYIZIAWUDBAIBBQAEIMTZ
# GxI3nFyH9mt+Vd+nQdQjV+iEMELsJm95P8tp5ttTAhEArxrQ0Qyel/bo0/KI6HAM
# zxgPMjAyMjAyMTEwMjM4NDVaoIIKNzCCBP4wggPmoAMCAQICEA1CSuC+Ooj/YEAh
...
# HAYJKoZIhvcNAQkFMQ8XDTIyMDIxMTAyMzg0NVowKwYLKoZIhvcNAQkQAgwxHDAa
# MBgwFgQU4deCqOGRvu9ryhaRtaq0lKYkm/MwLwYJKoZIhvcNAQkEMSIEIGoWrD/l
# xZ9puGIEq1+IaVHoOMu82mPbOcC93yA4a8KQMDcGCyqGSIb3DQEJEAIvMSgwJjAk
# MCIEILMQkAa8CtmDB5FXKeBEA0Fcg+MpK2FPJpZMjTVx7PWpMA0GCSqGSIb3DQEB
# AQUABIIBACK7/BCUUbtzD6DhZXpqkay8x39jtSIgFNrZKGYX2mlAG3RoKc75G3mH
# jGnt+UpByvm7nZJSOhIXqBS7KwTMeo6DXhAEWSv7nxNyW1cLoOVH+mJqwKJSYcSX
# epeZ9YgCdEIBLk37+ZktbhRxILAHQ9PilNM5IuYYYCBtXmXGqrj9KZduWO1/8Ekw
# MpCNbiywScfjG/eRPYnRDfUO2Jrp8TXyaJWy4KEdwje+y1d4Zb0bncgqJnQkOCmZ
# x86iB4sRZK2ApmFdIGGPEMkqpa3rpeObWXJsXbL16n3i9YHvAiwj5EL9l3u0zZOw
# u6IerkrIzF57A/jz5V4SDWBC98Ckyyg=
